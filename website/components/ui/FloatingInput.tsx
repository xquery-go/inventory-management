  ...
  return (
    <div className="relative w-full">
      ...
      <label
        htmlFor={name}
        className={cn(
          `z-[1] select-none font-roboto absolute text-sm text-gray-700 duration-300 transform -translate-y-4 scale-75 top-2 origin-[0] bg-supportBg  px-2 peer-focus:px-2 peer-focus:text-primaryCol peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4
